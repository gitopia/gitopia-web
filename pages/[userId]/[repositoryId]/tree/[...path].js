...
import { initRepository, loadDirectory } from "../../../../store/actions/git";
...
function RepositoryView(props) {
  ...
  useEffect(async () => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (res && res.entity && res.entity.tree) {
                        ...
                        <li>
                          <Link
                            href={[
                              ...
                              router.query.repositoryId,
                              "tree",
                              ...router.query.path.slice(0, i + 1),
                            ].join("/")}
                          >
                            <a>{router.query.path[i]}</a>
                          </Link>
                        </li>
                      );
                    })}
