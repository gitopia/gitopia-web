...
(function (V1ProposalExecutorResult) {
  V1ProposalExecutorResult["PROPOSAL_EXECUTOR_RESULT_UNSPECIFIED"] =
    "PROPOSAL_EXECUTOR_RESULT_UNSPECIFIED";
  V1ProposalExecutorResult["PROPOSAL_EXECUTOR_RESULT_NOT_RUN"] =
    "PROPOSAL_EXECUTOR_RESULT_NOT_RUN";
  V1ProposalExecutorResult["PROPOSAL_EXECUTOR_RESULT_SUCCESS"] =
    "PROPOSAL_EXECUTOR_RESULT_SUCCESS";
  V1ProposalExecutorResult["PROPOSAL_EXECUTOR_RESULT_FAILURE"] =
...
(function (V1ProposalStatus) {
  V1ProposalStatus["PROPOSAL_STATUS_UNSPECIFIED"] =
...
export class Api extends HttpClient {
  constructor() {
     ...
     */
    this.queryGroupInfo = (groupId, params = {}) =>
      this.request({
     ...
     */
    this.queryGroupMembers = (groupId, query, params = {}) =>
      this.request({
     ...
     */
    this.queryGroupPoliciesByAdmin = (admin, query, params = {}) =>
      this.request({
     ...
     */
    this.queryGroupPoliciesByGroup = (groupId, query, params = {}) =>
      this.request({
     ...
     */
    this.queryGroupPolicyInfo = (address, params = {}) =>
      this.request({
     ...
     */
    this.queryGroupsByAdmin = (admin, query, params = {}) =>
      this.request({
     ...
     */
    this.queryGroupsByMember = (address, query, params = {}) =>
      this.request({
     ...
     */
    this.queryProposalsByGroupPolicy = (address, query, params = {}) =>
      this.request({
     ...
     */
    this.queryVoteByProposalVoter = (proposalId, voter, params = {}) =>
      this.request({
     ...
     */
    this.queryVotesByProposal = (proposalId, query, params = {}) =>
      this.request({
     ...
     */
    this.queryVotesByVoter = (voter, query, params = {}) =>
      this.request({
