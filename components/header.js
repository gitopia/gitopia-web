...
import { Navbar, Nav, Icon, Dropdown, Tag, InputGroup, AutoComplete } from 'rsuite'
...
export default function Header() {
    ...
    return (
        <Navbar appearance="subtle">
          ...
          <Navbar.Body>
            <Nav>
              <InputGroup inside style={{width: 350, display: 'inline-flex', margin: 10}}>
                <AutoComplete data={data} placeholder="Search repositories / wallets" />
                <InputGroup.Addon>
                  <Icon icon="search" />
                </InputGroup.Addon>
              </InputGroup> 
