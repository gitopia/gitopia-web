...
function SupportProject(props) {
  ...
  return (
    <div className={"popup absolute p-12 mx-28 w-3/6 z-10"} tabIndex="0">
      <div className="dropdown-content bg-base-300 rounded p-8">
        ...
        <div class="flex border border-gray-700 rounded-lg p-3">
          <div className="w-11/12">{props.ownerId}</div>
          <button
            className="w-1/12"
            onClick={(e) => {
        ...
        <div>
          ...
          <div>
            <input
              ...
              className="w-full h-12 input input-sm input-ghost input-bordered "
            />
          </div>
          {validateAmountError ? (
            <label className="label">
        ...
        <div className="flex w-full mt-2 btn-group">
          ...
          <div className="w-1/12 ml-8 mt-5">
            <button
